    ...
    echo '
        <div class="container">
            <div class="card shadow my-5">
               ...
               echo  '<h1 class="font-weight-light text-center">Your ar on page: '. ucfirst($data['page']) .'</h1>';
                echo "<p>
                        ...
                        ze door elkaar husselde om een font-catalogus te maken. Het heeft niet alleen vijf eeuwen overleefd maar is
                        ook, vrijwel onveranderd, overgenomen in elektronische letterzetting. Het is in de jaren '60 populair
                        geworden met de introductie van Letraset vellen met Lorem Ipsum passages en meer recentelijk door desktop
